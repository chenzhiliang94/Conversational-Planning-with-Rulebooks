...
nohup python3 -u evaluation/run_evaluation.py --evaluation_data=evaluation_starters_test.txt --evaluation_depth=5 --cuda=4 --mcts_search_depth=4 --mcts_time=500 --pretrained_q_function=trained_q_function_daily_dialogueFULL --agent=pure_online --result_file=test_depth_4_time_500_resetQ_LR_1 > output/test_depth_4_time_500_resetQ_LR_1.out 2>&1 &