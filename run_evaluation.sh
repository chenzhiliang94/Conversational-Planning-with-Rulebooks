...
nohup python3 -u evaluation/run_evaluation.py --evaluation_data=evaluation_starters_test.txt --evaluation_depth=5 --cuda=4 --mcts_search_depth=8 --mcts_time=500 --pretrained_q_function=trained_q_function_daily_dialogueFULL --agent=pure_online --result_file=testing_2_actions_depth_10 > output/testing_2_actions_depth_10.out 2>&1 &